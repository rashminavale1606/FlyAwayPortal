...
<html>
  <head>
    ...
    />
    <script
      src="https://kit.fontawesome.com/92e9dde9ec.js"
      crossorigin="anonymous"
    ></script>
    <style>
      body {
      ...
      <div class="row">
          ...
          <nav class="navbar navbar-md">
            <div class="navbar-brand text-dark">
              <a href="index.jsp" class="text-decoration-none text-dark"
                ><i class="fas fa-plane"></i>FlyAway Portal</a
              >
            </div>
            <ul class="nav">
              <li class="nav-item">
                <a class="nav-link text-dark" href="login.jsp"
                  ><i class="fas fa-user-cog"></i> Admin Login</a
                >
              </li>
            </ul>
          </nav>
        ...
        <div class="col-md-12">
          <h2 class="text-center text-dark">
            Welcome to FlyAway booking portal
          </h2>
        </div>
        <div class="row">
